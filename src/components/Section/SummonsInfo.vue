    ...
    <div class="summonsInfo">
        <div class="dateTime__wrapper col">
            ...
            <div class="dateLocation">
                ...
                <div class="location"> <img src="../../assets/icons/location.png" /> <span>Саратов</span></div>
            </div>
        ...
        <div class="statistics col">
            ...
            <div class="description">Концентрация PM2.5 в городе Саратов сейчас в 2 раз(а) выше рекомендуемого ВОЗ среднегодового значения качества воздуха</div>
        </div>

        <div class="reference">
            <div class="title"><div class="diamond green"></div>Оценка воздуха</div>
            <ul>
                <li><div class="circle green"></div> <span>Хорошо</span></li>
                <li><div class="circle yellow"></div><span>Средне</span></li>
                <li><div class="circle orange"></div><span>Вредно для уязвимых групп</span></li>
                <li><div class="circle red"></div><span>Вредно</span></li>
                <li><div class="circle purple"></div><span>Очень вредно</span></li>
                <li><div class="circle maroon"></div><span>Опасно</span></li>
            </ul>
        </div>
    </div>
